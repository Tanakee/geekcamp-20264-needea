    ...
    <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-8">
      ...
      {!githubConnected ? (
        <div className="mb-6 rounded-xl overflow-hidden border border-slate-800">
          ...
          {/* 本文 */}
          <div className="bg-slate-950/80 px-5 py-4 flex items-center gap-5">
            <div className="flex-1">
              <p className="text-sm font-semibold text-slate-100 mb-1">Build-er 機能はロックされています</p>
              <p className="text-xs text-slate-400 leading-relaxed">
                GitHub連携することで、制作宣言・リポジトリ掲載・Build-er統計などが解放されます。
              </p>
            </div>
            <Button
              size="sm"
              className="shrink-0 gap-2 bg-slate-100 text-slate-900 hover:bg-white"
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        <div className={`border rounded-xl p-4 bg-card relative ${!githubConnected ? 'border-dashed border-border' : 'border-border'}`}>
          {!githubConnected && (
            <div className="absolute inset-0 flex flex-col items-center justify-center rounded-xl bg-background/80 backdrop-blur-[2px] z-10 gap-1">
